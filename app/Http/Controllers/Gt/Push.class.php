...
class Gt {
	...
	public function mtp($title,$text,$content) {
		...
		$tp->set_title($title);
		$tp->set_text($text);
		//$tp->set_logo("http://112.74.126.199/mone/image/push.png");
...
class IOS extends Gt {
	public $appId = 'tOmTDJRrU7781dymJGWj71';
	public $appKey = 'l7FAsfiRzk7vRC6zMIx7d2';
	public $masterSecret = 'wb5oUaG0Wj8tLDKHRmB3z6';
